  ...
  return (function (t) {
    ...
    function (t, e, i) {
      ...
      class H {
        ...
        _commonAncestorContainer(t, e) {
          var i = U(t || this.startContainer),
            n = U(e || this.endContainer);
          if (i[0] == n[0])
    ...
    function (t, e, i) {
      ...
      (r = function (t, e) {
        ...
        (a = {
          ...
          off: (s = function (t, e) {
            var i, n, r, s;
            if ((u(e), !m.call(this, "__ee__"))) return this;
          ...
          emit: (o = function (t) {
            var e, i, n, r, s;
            if (m.call(this, "__ee__") && (r = this.__ee__[t]))
              if ("object" == typeof r) {
                for (
        ...
        (t.exports = e =
          function (t) {
            return null == t ? p(l) : v(Object(t), h);
          }),
        (e.methods = a);
    },
    function (t, e, i) {
    ...
    function (t, e, i) {
      ...
      t.exports = function (t) {
        return (
          s(l, t) || (a && s(c, t) ? (l[t] = c[t]) : (l[t] = u("Symbol." + t))),
          l[t]
        );
      };
    },
    ...
    function (t, e, i) {
      ...
      (t.exports = function (t, e, i, a) {
        ...
        "function" == typeof i &&
          ...
          (c(i).source = u.join("string" == typeof e ? e : ""))),
          t !== n
            ? (h ? !d && t[e] && (l = !0) : delete t[e],
              l ? (t[e] = i) : r(t, e, i))
            : l
            ? (t[e] = i)
            : o(e, i);
    ...
    function (t, e, i) {
      ...
      var n,
        ...
        z = function (t, e) {
          ...
          if ("[" == e.charAt(0)) {
            ...
            if (!(i = q(e.slice(1, -1)))) return "Invalid host";
            t.host = i;
          } else if (G(t)) {
            if (((e = g(e)), N.test(e))) return "Invalid host";
            if (null === (i = B(e))) return "Invalid host";
            t.host = i;
          } else {
            if (A.test(e)) return "Invalid host";
            for (i = "", n = f(e), r = 0; r < n.length; r++) i += V(n[r], U);
            t.host = i;
          }
        },
        B = function (t) {
          var e,
            ...
            h = t.split(".");
          if (
            (h.length && "" == h[h.length - 1] && h.pop(), (e = h.length) > 4)
          )
            return t;
          for (i = [], n = 0; n < e; n++) {
            if ("" == (r = h[n])) return t;
            if (
              ...
              r.length > 1 &&
                "0" == r.charAt(0) &&
                ((s = R.test(r) ? 16 : 8), (r = r.slice(8 == s ? 1 : 2))),
              "" === r)
            )
              o = 0;
            else {
              if (!(10 == s ? I : 8 == s ? L : j).test(r)) return t;
              o = parseInt(r, s);
            }
            i.push(o);
          }
          for (n = 0; n < e; n++)
            if (((o = i[n]), n == e - 1)) {
              if (o >= O(256, 5 - e)) return null;
            } else if (o > 255) return null;
          for (a = i.pop(), n = 0; n < i.length; n++) a += i[n] * O(256, 3 - n);
          return a;
        },
        q = function (t) {
          var e,
          ...
          for (; d(); ) {
            if (8 == l) return;
            if (":" != d()) {
              for (e = i = 0; i < 4 && j.test(d()); )
                (e = 16 * e + parseInt(d(), 16)), u++, i++;
              if ("." == d()) {
                if (0 == i) return;
                if (((u -= i), l > 6)) return;
                for (n = 0; d(); ) {
          ...
          if (null !== c)
            for (o = l - c, l = 7; 0 != l && o > 0; )
              (a = h[l]), (h[l--] = h[c + o - 1]), (h[c + --o] = a);
          else if (8 != l) return;
          return h;
        },
        M = function (t) {
          ...
          for (
            ...
            switch (((o = s[d]), c)) {
              ...
              case ot:
                ...
                break;
              case at:
                if (((c = ht), "/" != o || "/" != p.charAt(d + 1))) continue;
                d++;
                break;
              case ht:
                if ("/" != o && "\\" != o) {
                ...
                if (!k.test(o)) {
                  if (
                    ...
                    if ("" != p) {
                      ...
                      (t.port = G(t) && x === X[t.scheme] ? null : x), (p = "");
                    }
                    if (i) return;
                    c = vt;
                    continue;
              ...
              case vt:
                if (G(t)) {
                  if (((c = mt), "/" != o && "\\" != o)) continue;
                } else if (i || "?" != o)
                  if (i || "#" != o) {
                    if (o != n && ((c = mt), "/" != o)) continue;
        ...
        Et = function (t) {
          var e,
            ...
            a = E(n, { type: "URL" });
          if (void 0 !== r)
            if (r instanceof Et) e = S(r);
            else if ((i = xt((e = {}), String(r)))) throw TypeError(i);
          if ((i = xt(a, o, null, e))) throw TypeError(i);
          var h = (a.searchParams = new w()),
            l = x(h);
          l.updateSearchParams(a.query),
            (l.updateURL = function () {
              a.query = String(h) || null;
            }),
            s ||
              ((n.href = _t.call(n)),
              (n.origin = Ot.call(n)),
              (n.protocol = Ct.call(n)),
        ...
        Rt = function () {
          var t = S(this),
            e = t.host,
            i = t.port;
          return null === e ? "" : null === i ? M(e) : M(e) + ":" + i;
        },
        Lt = function () {
          var t = S(this).host;
          return null === t ? "" : M(t);
      ...
      if (
        (s &&
          h(St, {
            ...
            origin: Dt(Ot),
            protocol: Dt(Ct, function (t) {
              var e = S(this);
              xt(e, String(t) + ":", tt);
            }),
            username: Dt(Tt, function (t) {
              var e = S(this),
                i = f(String(t));
              if (!$(e)) {
                e.username = "";
                for (var n = 0; n < i.length; n++) e.username += V(i[n], H);
              }
            }),
            password: Dt(kt, function (t) {
              ...
              if (!$(e)) {
                e.password = "";
                for (var n = 0; n < i.length; n++) e.password += V(i[n], H);
              }
            }),
            ...
            port: Dt(It, function (t) {
              var e = S(this);
              $(e) || ("" == (t = String(t)) ? (e.port = null) : xt(e, t, dt));
            }),
            pathname: Dt(jt, function (t) {
              var e = S(this);
      ...
      v(Et, "URL"), r({ global: !0, forced: !o, sham: !s }, { URL: Et });
    },
    function (t, e, i) {
      "use strict";
      var n = i(0);
          ...
          return (
            ...
            t.map((t) => {
              ...
              let d = this.mapping.page(t.contents, t.section.cfiBase, s, o),
                ...
                g = [],
                v = Math.floor(o / this.layout.pageWidth);
              if (
                (p < 0 && ((p = 0), (v += 1)),
                "rtl" === this.settings.direction)
              ) {
        ...
        return [
          ...
          function (t, n) {
            ...
            for (var x = []; ; ) {
              ...
              if (null === E) break;
              if ((x.push(E), !g)) break;
              "" === String(E[0]) && (h.lastIndex = l(f, o(h.lastIndex), w));
            }
            for (var S, _ = "", O = 0, C = 0; C < x.length; C++) {
              E = x[C];
              for (
                var T = String(E[0]),
                  k = u(d(a(E.index), f.length), 0),
                  R = [],
                  L = 1;
                L < E.length;
                L++
              )
                R.push(void 0 === (S = E[L]) ? S : String(S));
              var I = E.groups;
              if (p) {
                var j = [T].concat(R, k, f);
                void 0 !== I && j.push(I);
                var N = String(n.apply(void 0, j));
              } else N = b(T, f, k, R, I, n);
              k >= O && ((_ += f.slice(O, k) + N), (O = k + T.length));
            }
            return _ + f.slice(O);
          },
        ];
        function b(t, i, n, r, o, a) {
          var h = n + t.length,
            l = r.length,
            c = g;
          return (
      ...
      e.Underline = (function (t) {
        function e(t, i, n, r) {
          return (
            ...
            a(
              this,
              (e.__proto__ || Object.getPrototypeOf(e)).call(this, t, i, n, r)
            )
          );
        }
        return (
    ...
    function (t, e, i) {
      ...
      t.exports = function (t, e) {
        var i,
          ...
          g = t.global,
          v = t.stat;
        if ((i = g ? n : v ? n[p] || a(p, {}) : (n[p] || {}).prototype))
          for (c in e) {
            if (
              ((d = e[c]),
              (u = t.noTargetGet ? (f = r(i, c)) && f.value : i[c]),
              !l(g ? c : p + (v ? "." : "#") + c, t.forced) && void 0 !== u)
            ) {
    ...
    function (t, e, i) {
      ...
      class b {
        ...
        requireView(t) {
          return "string" == typeof t && "iframe" === t ? v.a : t;
        }
        start() {
          switch (
          ...
          return (
            ...
            l
              ? n
                ...
                : (o.lastIndex = 0)
              : c && n && (o.lastIndex = o.global ? n.index + n[0].length : e),
            d &&
              n &&
              n.length > 1 &&
              h.call(n[0], i, function () {
    ...
    function (t, e, i) {
      ...
      class c {
        ...
        mark(t, e = {}, i) {
          ...
          n.collapsed && 1 === r.nodeType
            ? ((n = new Range()), n.selectNodeContents(r))
            : n.collapsed && ((n = new Range()), n.selectNodeContents(s));
    ...
    function (t, e, i) {
      ...
      t.exports = function (t, e, i) {
        ...
        function w(t) {
          var i = t - f;
          return void 0 === f || i >= e || i < 0 || (v && t - p >= c);
        }
        function x() {
          var t = r();
          if (w(t)) return E(t);
          d = setTimeout(
            ...
            (function (t) {
              var i = e - (t - f);
              return v ? a(i, c - (t - p)) : i;
            })(t)
          );
        }
        function E(t) {
          return (d = void 0), m && h ? y(t) : ((h = l = void 0), u);
        }
        function S() {
          var t = r(),
            i = w(t);
          if (((h = arguments), (l = this), (f = t), i)) {
            ...
            if (v) return clearTimeout(d), (d = setTimeout(x, e)), y(f);
          }
        ...
        return (
          ...
          n(i) &&
            ((g = !!i.leading),
            (c = (v = "maxWait" in i) ? o(s(i.maxWait) || 0, e) : c),
      ...
      class p extends r.a {
        ...
        check(t, e) {
          ...
          h + l + o >= c &&
            ...
            g < 0 && p();
          let v = r.map((t) => t.display(this.request));
          return r.length
            ? Promise.all(v)
                .then(() => this.check())
                .then(
              ...
              function (t, e, i) {
                ...
                var C = {
                    ...
                    _initStorage: function (t) {
                      ...
                      r ||
                        ...
                        r.forages.push(e),
                        e._initReady ||
                          ((e._initReady = e.ready), (e.ready = _));
                      var s = [];
                      function a() {
                        return o.resolve();
                      }
                    ...
                    iterate: function (t, e) {
                      var i = this,
                        n = new o(function (e, n) {
                          i.ready()
                            .then(function () {
                              O(i._dbInfo, "readonly", function (r, s) {
                                if (r) return n(r);
                                try {
                                  var o = s
                    ...
                    setItem: function (t, e, i) {
                      ...
                      var r = new o(function (i, r) {
                        ...
                        n.ready()
                          ...
                          .then(function (e) {
                            O(n._dbInfo, "readwrite", function (s, o) {
                              if (s) return r(s);
                              try {
                    ...
                    removeItem: function (t, e) {
                      ...
                      var n = new o(function (e, n) {
                        i.ready()
                          .then(function () {
                            O(i._dbInfo, "readwrite", function (r, s) {
                              if (r) return n(r);
                              try {
                                var o = s
                                  .objectStore(i._dbInfo.storeName)
                    ...
                    clear: function (t) {
                      var e = this,
                        i = new o(function (t, i) {
                          e.ready()
                            .then(function () {
                              O(e._dbInfo, "readwrite", function (n, r) {
                                if (n) return i(n);
                                try {
                                  var s = r
                    ...
                    length: function (t) {
                      var e = this,
                        i = new o(function (t, i) {
                          e.ready()
                            .then(function () {
                              O(e._dbInfo, "readonly", function (n, r) {
                                if (n) return i(n);
                                try {
                                  var s = r
                                    .objectStore(e._dbInfo.storeName)
                                ...
                                return new o(function (e, n) {
                                  ...
                                  .then(function (t) {
                                    ...
                                    for (var e = 0; e < s.length; e++) {
                                      var i = s[e];
                                      (i._dbInfo.db = t), v(i._dbInfo);
                                    }
                                  })
                                  .catch(function (e) {
                                    throw (
                                      ((m(t, e) || o.resolve()).catch(
                                        function () {}
                                      ),
                                      e)
                                    );
                ...
                var A = {
                  ...
                  deserialize: function (t) {
                    if ("__lfsc__:" !== t.substring(0, R)) return JSON.parse(t);
                    var e,
                      i = t.substring(L),
                      n = t.substring(R, L);
                    if ("blob" === n && k.test(i)) {
    ...
    function (t, e, i) {
        ...
        setCurrent(t) {
          ...
          0 !== this._locations.length &&
            ("string" == typeof t
              ...
              : (e = t),
            this.emit(v.c.LOCATIONS.CHANGED, {
      ...
      var S = class {
          ...
          parseNav(t) {
            var e,
              i,
              n = Object(s.querySelectorByType)(t, "nav", "toc"),
            ...
            for (e = 0; e < o; ++e)
              (i = this.navItem(r[e])) &&
                ((a[i.id] = i),
                i.parent ? a[i.parent].subitems.push(i) : h.push(i));
            return h;
          }
          navItem(t) {
            let e = t.getAttribute("id") || void 0,
              i = Object(s.filterChildren)(t, "a", !0);
            if (!i) return;
            ...
            return { id: e, href: n, label: o, subitems: [], parent: r };
          }
          parseLandmarks(t) {
            var e,
              i,
        ...
        O = (function () {
          ...
          for (t in _)
            if (_.hasOwnProperty(t))
              for (e in _[t])
                if (_[t].hasOwnProperty(e))
                  if ("string" == typeof (i = _[t][e])) r[i] = t + "/" + e;
      ...
      class H {
          ...
          void 0 === e &&
            ...
            t &&
              this.open(t, this.settings.openAs).catch((e) => {
                ...
                this.emit(v.c.BOOK.OPEN_FAILED, i);
              });
        }
        open(t, e) {
          var i,
          ...
          (this.package = t),
            "" === this.packaging.metadata.layout
              ? this.load(
                  ...
                  .then((t) => {
                    (this.displayOptions = new z(t)),
                      this.loading.displayOptions.resolve(this.displayOptions);
                  })
                  .catch((t) => {
                    (this.displayOptions = new z()),
                      this.loading.displayOptions.resolve(this.displayOptions);
                  })
              : ((this.displayOptions = new z()),
                this.loading.displayOptions.resolve(this.displayOptions)),
        ...
        unarchive(t, e) {
          return (this.archive = new j()), this.archive.open(t, e);
        }
        store(t) {
          let e =
              this.settings.replacements &&
          ...
          return (
            (this.storage = new D(t, n, this.resolve.bind(this))),
    ...
    function (t, e, i) {
      ...
      t.exports = function (t, e, i, c, f, y, b) {
        r(i, e, c);
        var w,
          x,
          E,
        ...
        if (
          (R &&
            ...
            p !== Object.prototype &&
              ...
              (u ||
                s(w) === p ||
                (o ? o(w, p) : "function" != typeof w[v] && h(w, v, m)),
              a(w, _, !0, !0),
              u && (d[_] = m))),
          "values" == f &&
            T &&
          ...
          if (
            ...
            for (E in x) (g || O || !(E in C)) && l(C, E, x[E]);
          else n({ target: e, proto: !0, forced: g || O }, x);
        return x;
      };
    },
    function (t, e, i) {
      "use strict";
      var n = i(76).IteratorPrototype,
        r = i(50),
        s = i(25),
        o = i(37),
        a = i(27),
    ...
    function (t, e, i) {
      var n = i(12),
        ...
        s = function (t, e) {
          var i = a[o(t)];
          return i == l || (i != h && ("function" == typeof e ? n(e) : !!e));
        },
    ...
    function (t, e, i) {
      "use strict";
      t.exports = i(110)() ? Object.assign : i(111);
    },
    function (t, e, i) {
      "use strict";
      t.exports = function () {
    ...
    function (t, e, i) {
      "use strict";
      t.exports = i(113)() ? Object.keys : i(114);
    },
    function (t, e, i) {
      "use strict";
      t.exports = function () {
    ...
    function (t, e, i) {
      "use strict";
      t.exports = i(120)() ? String.prototype.contains : i(121);
    },
    function (t, e, i) {
      "use strict";
      var n = "razdwatrzy";
    ...
    function (t, e, i) {
      ...
      t.exports = function (t) {
        var e,
          ...
          w = 0;
        if (
          (y && (m = n(m, v > 2 ? arguments[2] : void 0, 2)),
          null == b || (g == Array && o(b)))
        )
          for (i = new g((e = a(p.length))); e > w; w++)
            (f = y ? m(p[w], w) : p[w]), h(i, w, f);
        else
          for (
            d = (u = b.call(p)).next, i = new g();
            !(c = d.call(u)).done;
            w++
          )
            (f = y ? s(u, m, [c.value, w], !0) : c.value), h(i, w, f);
        return (i.length = w), i;
      };
    },
    function (t, e) {
    ...
    function (t, e, i) {
      var n = {};
      (n[i(8)("toStringTag")] = "z"), (t.exports = "[object z]" === String(n));
    },
    function (t, e, i) {
      "use strict";
      var n = /[^\0-\u007E]/,
        ...
        l = function (t, e, i) {
          var n = 0;
          for (t = i ? o(t / 700) : t >> 1, t += o(t / e); t > 455; n += 36)
            t = o(t / 35);
        ...
        c = function (t) {
          ...
          for (f && n.push("-"); p < r; ) {
            var g = 2147483647;
            for (e = 0; e < t.length; e++) (i = t[e]) >= c && i < g && (g = i);
            var v = p + 1;
            if (g - c > o((2147483647 - u) / v)) throw RangeError(s);
            for (u += (g - c) * v, c = g, e = 0; e < t.length; e++) {
              if ((i = t[e]) < c && ++u > 2147483647) throw RangeError(s);
              if (i == c) {
                for (var m = u, y = 36; ; y += 36) {
                  var b = y <= d ? 1 : y >= d + 26 ? 26 : y - d;
                  if (m < b) break;
                  var w = m - b,
                    x = 36 - b;
                  n.push(a(h(b + (w % x)))), (m = o(w / x));
                }
                n.push(a(h(m))), (d = l(u, v, p == f)), (u = 0), ++p;
              }
            }
            ++u, ++c;
          }
      ...
      t.exports = function (t) {
        ...
        for (e = 0; e < o.length; e++)
          (i = o[e]), s.push(n.test(i) ? "xn--" + c(i) : i);
        return s.join(".");
      };
    },
    function (t, e, i) {
        ...
        z = function (t, e) {
          if (e)
            for (var i, n, r = e.split("&"), s = 0; s < r.length; )
              (i = r[s++]).length &&
                ((n = i.split("=")),
                t.push({ key: j(n.shift()), value: j(n.join("=")) }));
        },
        B = function (t) {
            ...
            if (v(l))
              if ("function" == typeof (t = w(l)))
                for (i = (e = t.call(l)).next; !(n = i.call(e)).done; ) {
                  if (
                    (o = (s = (r = b(g(n.value))).next).call(r)).done ||
                    (a = s.call(r)).done ||
                    !s.call(r).done
                  )
                    throw TypeError("Expected sequence with length 2");
                  f.push({ key: o.value + "", value: a.value + "" });
                }
              else for (h in l) d(l, h) && f.push({ key: h, value: l[h] + "" });
            else
              z(
                f,
                "string" == typeof l
      ...
      a(
        F,
        {
          ...
          delete: function (t) {
            ...
            for (
              var e = C(this), i = e.entries, n = t + "", r = 0;
              r < i.length;
          ...
          get: function (t) {
            q(arguments.length, 1);
            for (var e = C(this).entries, i = t + "", n = 0; n < e.length; n++)
          ...
          getAll: function (t) {
            q(arguments.length, 1);
            for (
              var e = C(this).entries, i = t + "", n = [], r = 0;
              r < e.length;
              r++
            )
          ...
          has: function (t) {
            q(arguments.length, 1);
            for (var e = C(this).entries, i = t + "", n = 0; n < e.length; )
          ...
          set: function (t, e) {
            ...
            for (
              ...
              (i = r[h]).key === o &&
                (s ? r.splice(h--, 1) : ((s = !0), (i.value = a)));
            s || r.push({ key: o, value: a }), n.updateURL();
          },
          sort: function () {
            var t,
              e,
        ...
        o(
          ...
          "toString",
          function () {
            for (var t, e = C(this).entries, i = [], n = 0; n < e.length; )
              (t = e[n++]), i.push(D(t.key) + "=" + D(t.value));
            return i.join("&");
          },
          { enumerable: !0 }
        ),
        h(U, "URLSearchParams"),
        n({ global: !0, forced: !s }, { URLSearchParams: U }),
        s ||
          "function" != typeof E ||
          "function" != typeof S ||
          n(
        ...
        (t.exports = { URLSearchParams: U, getState: C });
    },
    function (t, e, i) {
      var n = i(19);
      t.exports = function (t, e, i) {
